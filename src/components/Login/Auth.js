          ...
          <div className="main-content">
            ...
            <Card className="bg-secondary shadow border-0">
              ...
              <CardBody className="px-lg-5 py-lg-5">
                ...
                {this.state.valid === 1 &&
                  <div className="text-center text-muted mb-4">
                      <small style={{color: 'red'}}>Invalid Credentials! Please try again.</small>
                  </div> }
                <Form role="form">
                  <FormGroup className="mb-3">
                    <InputGroup className="input-group-alternative">
                      ...
                      <Input placeholder="Email" type="email" autoComplete="new-email" defaultValue={this.state.email}
                  ...
                  <FormGroup>
                    <InputGroup className="input-group-alternative">
                      ...
                      <Input placeholder="Password" type="password" autoComplete="new-password" defaultValue={this.state.password}
